      ...
      return function(f2) {
        ...
        var _ = function(f3) {
          ...
          var f3 = function(f4) {
            ...
            if (e3.host)
              return l([e3.host, e3.path, "" + f4 + "." + e3.ext]).join("/");
            if ("twemoji" === e3.emojiType)
              return "https://twemoji.maxcdn.com/" + e3.ext + "/" + f4 + "." + e3.ext;
            if ("emojione" === e3.emojiType)
              return "http://cdn.jsdelivr.net/emojione/assets/" + e3.ext + "/" + f4.toUpperCase() + "." + e3.ext;
            ...
            if (e3.strict && !n2)
              throw new Error("Could not find emoji: " + f4 + ".");
            ...
            return l(f4.split(_3).map(function(f5, a4) {
              var t2 = f5.match(_3);
              if (e3.strict && "" !== f5 && null === t2)
                throw new Error("Could not find emoji: " + f5 + ".");
              if (t2) {
                var r2 = n2[g(t2[0])];
